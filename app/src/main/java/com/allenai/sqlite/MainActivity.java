...
public class MainActivity extends Activity {
    ...
    public static final String permission1 = Manifest.permission.READ_EXTERNAL_STORAGE;
    public static final String permission2 = Manifest.permission.WRITE_EXTERNAL_STORAGE;
    public static final String[] permission = new String[]{permission1, permission2};//敏感权限
...
//        int code = ContextCompat.checkSelfPermission(this,permission2);
...
//        }
        ...
        if (!has) {
            ...
            PermissionUtils.requestMorePermissions(this, permission, reqCode);
